			...
			<div className={style.heroContent}>
				<Container maxWidth='sm' className={style.heroContainer}>
					...
					<Typography
						...
						Quisque tincidunt lorem leo, et rhoncus massa aliquam
						vel. Quisque a metus interdum, vulputate ligula ut,
						gravida velit. Aenean elit metus, tempus sed tortor a,
						condimentum congue felis.
					</Typography>
